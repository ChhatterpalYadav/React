    ...
    <>
      ...
      style={{backgroundColor: color}}>
        <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">
          <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-orange-600 px-3 py-2 rounded-3xl">
            ...
            <button onClick={() => setColor("silver")} className="outline-none px-4 rounded-full text-white shadow-lg" style={{backgroundColor: "silver"}}>Silver</button>
          </div>
        </div>
